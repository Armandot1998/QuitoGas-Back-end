...
const { id_producto,nombre_producto,precio_producto  } = req.body.producto;
producto = await pool.query('update producto set  nombre_producto = $1,precio_producto = $2 where id_usuario = $3' ,
